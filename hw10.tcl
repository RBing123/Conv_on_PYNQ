...
proc create_root_design { parentCell } {
  ...
  set conv_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:conv:1.0 conv_1 ]
  ...
  connect_bd_net -net Net [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_cdma_0/m_axi_aclk] [get_bd_pins axi_cdma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins blk_mem_gen_1/clkb] [get_bd_pins conv_1/clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_cdma_0/s_axi_lite_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins conv_1/rst] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_0/gpio2_io_o] [get_bd_pins conv_1/start]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins blk_mem_gen_0/doutb] [get_bd_pins conv_1/M0_R_data]
  connect_bd_net -net blk_mem_gen_1_doutb [get_bd_pins blk_mem_gen_1/doutb] [get_bd_pins conv_1/M1_R_data]
  connect_bd_net -net conv_1_M0_R_req [get_bd_pins blk_mem_gen_0/enb] [get_bd_pins conv_1/M0_R_req]
  connect_bd_net -net conv_1_M0_W_data [get_bd_pins blk_mem_gen_0/dinb] [get_bd_pins conv_1/M0_W_data]
  connect_bd_net -net conv_1_M0_W_req [get_bd_pins blk_mem_gen_0/web] [get_bd_pins conv_1/M0_W_req]
  connect_bd_net -net conv_1_M0_addr [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins conv_1/M0_addr]
  connect_bd_net -net conv_1_M1_R_req [get_bd_pins blk_mem_gen_1/enb] [get_bd_pins conv_1/M1_R_req]
  connect_bd_net -net conv_1_M1_W_data [get_bd_pins blk_mem_gen_1/dinb] [get_bd_pins conv_1/M1_W_data]
  connect_bd_net -net conv_1_M1_W_req [get_bd_pins blk_mem_gen_1/web] [get_bd_pins conv_1/M1_W_req]
  connect_bd_net -net conv_1_M1_addr [get_bd_pins blk_mem_gen_1/addrb] [get_bd_pins conv_1/M1_addr]
  connect_bd_net -net conv_1_finish [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins conv_1/finish]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_reset [get_bd_pins blk_mem_gen_0/rstb] [get_bd_pins blk_mem_gen_1/rstb] [get_bd_pins proc_sys_reset_0/peripheral_reset]
